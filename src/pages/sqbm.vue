    ...
    <div class="sqbm_container">
        ...
        <ul>
            <li>
                ...
                <!-- 2.代报名跳转 -->
                <span @click="$router.push({'name': 'Dbm'})">添加代报名</span>
            </li>
            <li>
                <!-- <span>经销商</span>
                <span><input type="text" placeholder="请输入公司名称"></span> -->
              <group>
                <x-input title="经销商" name="name1" placeholder="请输入公司名称" is-type="china" placeholder-align="right" text-align="right" :show-clear="false"></x-input>
              </group>
            </li>
            <li>
                <!-- <span>姓名</span>
                ...
                <group>
                <x-input title="姓名" name="username" placeholder="请输入姓名" :max="5" is-type="china-name" placeholder-align="right" text-align="right" :show-clear="false" should-toast-error="true"></x-input>
              </group>
            </li>
            <li>
                <group>
            ...
            <li>
              ...
              <group>
                <x-input title="手机"  name="mobile" placeholder="请输入手机号码" keyboard="number" is-type="china-mobile" placeholder-align="right" text-align="right" :show-clear="false" should-toast-error="true"></x-input>
              </group> 
            </li>
            <li>
                <!-- <span>身份证</span>
                ...
                <group>
                <x-input title="身份证"  name="name2" placeholder="请输入身份证号码" :max="18"  ref="input2" is-type="custom()" @on-change="custom(value)" placeholder-align="right" text-align="right" :show-clear="false" ></x-input>
              </group> 
            </li>
            <li class="cel2">
                <!-- <span>性别</span>
